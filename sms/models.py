...
class WaterMeterReadingSmsRaw(models.Model):
    names = models.CharField(max_length=250)
    msisdn = models.CharField(max_length=250)    
...
class WaterSmsOutArrearsReminder(models.Model):
    timestamp = models.CharField(max_length=250,null=True)
    user_id = models.IntegerField(null=True)
    text_message = models.CharField(max_length=400)
    message_length = models.IntegerField(null=True, default=0)
    ...
    class Meta:
        db_table = "water_sms_out_arrears_reminders"
...
class MainMeterReplacements(models.Model):
    client = models.ForeignKey(WaterNetwork, on_delete=models.CASCADE)
    comments = models.CharField(max_length=250)
    meter_number = models.CharField(max_length=250, null=True)
    last_units = models.CharField(max_length=250)
    names = models.CharField(max_length=250, null=True)
...
class WaterCourtsReallocate(models.Model):
    client = models.ForeignKey(WaterClientAll, on_delete=models.CASCADE)
    curr_court = models.CharField(max_length=250)
    prev_court = models.CharField(max_length=250)
    curr_network = models.CharField(max_length=250)    
